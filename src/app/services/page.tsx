    ...
    <div className="py-12 sm:py-16 md:py-24">
      <Container>
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 px-4">Our Services</h1>
          <p className="text-colatech-grey-3 text-base sm:text-lg md:text-xl max-w-3xl mx-auto px-4">
            ...
            return (
              <Link key={service.id} href={`/services/${service.attributes.slug}`}>
                <Card hoverable clickable className="h-full">
                  ...
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3">{service.attributes.title}</h2>
                  <p className="text-colatech-grey-3 text-sm sm:text-base">{service.attributes.shortDescription}</p>
                  <div className="mt-3 sm:mt-4 text-colatech-green hover:underline text-sm sm:text-base">
                    Learn more →
                  </div>
                </Card>
              </Link>
